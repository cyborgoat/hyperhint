                    ...
                    if file_attachments:
                        ...
                        if user_input.strip():
                            ...
                            if len(file_attachments) == 1:
                                original_name = file_attachments[0].get(
                                ...
                                words = re.findall(
                                    r"\b[a-zA-Z]{3,}\b", base_name.lower()
                                )
                                if words:
                                    filename = f"{words[0]}.txt"
                                else:
                        ...
                        actual_filename = short_term_memory.add_knowledge_file(
                            filename, combined_content
                        )
                        ...
                        return {
                            "action": "add_knowledge",
                            "message": "No valid file attachments found",
                            "status": "error",
                        }
